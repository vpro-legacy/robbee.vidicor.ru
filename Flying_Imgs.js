...
Image0 = new Image(); Image0.src = grphcs[0] = "Img/Coming_SoonZR.png";
Image1 = new Image(); Image1.src = grphcs[1] = "Img/Coming_SoonZG.png";
Image2 = new Image(); Image2.src = grphcs[2] = "Img/Coming_SoonZB.png";
Image3 = new Image(); Image3.src = grphcs[3] = "Img/Coming_SoonZBr.png";
Image4 = new Image(); Image4.src = grphcs[4] = "Img/Coming_SoonZGy.png"; 
Image5 = new Image(); Image5.src = grphcs[5] = "Img/Coming_SoonZYl.png";
...
Amount=1; // Количество элементов на экране, выдаются Amount штук из диапазона [1, graphks] на всю работу.
...
{ 
  ...
  Speed[i] = Math.random() * 5 +3; // Скрость двиджения 5+3
  Cstep[i] = 1; // 1
